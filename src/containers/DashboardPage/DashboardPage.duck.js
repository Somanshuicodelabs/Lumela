...
export const SHOW_USER_REQUEST = 'app/DashboardPage/SHOW_USER_REQUEST';
export const SHOW_USER_SUCCESS = 'app/DashboardPage/SHOW_USER_SUCCESS';
export const SHOW_USER_ERROR = 'app/DashboardPage/SHOW_USER_ERROR';

export const QUERY_LISTINGS_REQUEST = 'app/DashboardPage/QUERY_LISTINGS_REQUEST';
export const QUERY_LISTINGS_SUCCESS = 'app/DashboardPage/QUERY_LISTINGS_SUCCESS';
export const QUERY_LISTINGS_ERROR = 'app/DashboardPage/QUERY_LISTINGS_ERROR';

export const QUERY_REVIEWS_REQUEST = 'app/DashboardPage/QUERY_REVIEWS_REQUEST';
export const QUERY_REVIEWS_SUCCESS = 'app/DashboardPage/QUERY_REVIEWS_SUCCESS';
export const QUERY_REVIEWS_ERROR = 'app/DashboardPage/QUERY_REVIEWS_ERROR';
