...
import css from './ManageServiceListingsCard.module.css';
...
export const ManageServiceListingsCardComponent = props => {
...
ManageServiceListingsCardComponent.defaultProps = {
  className: null,
  rootClassName: null,
...
ManageServiceListingsCardComponent.propTypes = {
  className: string,
...
export default compose(
  withRouter,
  injectIntl
)(ManageServiceListingsCardComponent);
